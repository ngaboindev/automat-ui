      ...
      <div className="px-8 py-10">
        <div className="grid grid-cols-4">
          <div className="text-center space-y-3 text-white">
            <h3 className="text-7xl font-semibold">2010</h3>
            <p className="text-sm">the year of foundation</p>
          </div>
          <div className="text-center space-y-3 text-white">
            <h3 className="text-7xl font-semibold">741+</h3>
            <p className="text-sm">solutions delivered</p>
          </div>
          <div className="text-center space-y-3 text-white">
            <h3 className="text-7xl font-semibold">411+</h3>
            <p className="text-sm">professionals and growing</p>
          </div>
          <div className="text-center space-y-3 text-white">
            <h3 className="text-7xl font-semibold">90%</h3>
            <p className="text-sm">
