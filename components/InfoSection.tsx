      ...
      <div className="wrapper text-white">
        ...
        <div className="grid grid-cols-4 gap-12">
          <div className="text-center space-y-4">
            ...
            <p className="text-primary text-xl">Shine a light on dark data.</p>
            <p>
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-primary text-xl">Fast response times.</p>
            <p>
              Vivamus condimentum praesent duis himenaeos netus diam gravida
              tempor tristique
            </p>
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-primary text-xl">Automate workflows.</p>
            <p>
              Vivamus condimentum praesent duis himenaeos netus diam gravida
              tempor tristique
            </p>
